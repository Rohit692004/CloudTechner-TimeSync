...
type Task = { id: string; name: string; projectName: string; clientName: string };
...
export function TimesheetGrid({
  ...
  // tasks arrives pre-sorted by clientName -> projectName -> name from the server,
  // so grouping by insertion order here preserves that sort.
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="overflow-x-auto">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead className="min-w-48">Client / Project / Task</TableHead>
              {dates.map((date, i) => (
